"""
Bybit exchange implementation for BDK Trading Bot.

This module provides Bybit exchange integration using the CCXT library,
...
class BybitExchange(BaseExchange):
    ...
    # Bybit rate limits
    RATE_LIMIT_REQUESTS = 600  # Per minute for public endpoints
    RATE_LIMIT_ORDERS = 20  # Per second
    ...
    def __init__(
        ...
        api_key: str = "",
        api_secret: str = "",
        passphrase: str = "",  # Not used by Bybit
    ...
    async def _execute_paper_order(
        ...
        """Execute paper order and update balances."""
