"""
KuCoin exchange implementation for BDK Trading Bot.

This module provides KuCoin exchange integration using the CCXT library,
supporting both real and paper trading modes. KuCoin requires a passphrase
...
@register_exchange("kucoin")
class KuCoinExchange(BaseExchange):
    """
    KuCoin exchange implementation using CCXT.

    KuCoin specific features:
    - Requires passphrase for API authentication
    - Known for listing new altcoins early
    - Good liquidity for mid-cap coins
    ...
    RATE_LIMIT_ORDERS = 45  # Per 3 seconds
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            passphrase: KuCoin API passphrase (required for private endpoints)
            paper_trading: If True, simulate orders locally
            sandbox: If True, use KuCoin sandbox environment
        """
        super().__init__(
            api_key=api_key,
        ...
        self._client: Optional[ccxt.kucoin] = None
    ...
    async def connect(self) -> bool:
        ...
        try:
            self.logger.info("Connecting to KuCoin...")
            ...
            self._client = ccxt.kucoin(config)
